...
import AuthButton from '@/app/(delete-this-and-modify-page.tsx)/AuthButton';
...
const NavigationBar = () => {
    return (
        <div className='flex w-full items-center justify-between gap-6 sm:justify-end sm:px-6'>
            <AuthButton />
            <ThemeSwitch />
            <Link href='https://github.com/SiddharthaMaity/nextjs-15-starter-authjs' target='_blank'>
                {/* prettier-ignore */}
